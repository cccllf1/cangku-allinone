...
const MobileLocationInventory = () => {
  ...
  return (
    <div className="page-container">
      ...
      >
        <div className="filter-popup">
          ...
          <div className="filter-footer">
            <Button block danger onClick={clearFilters} style={{ borderRadius: 24, margin: 24, color: '#ff4d4f', borderColor: '#ff4d4f' }}>
              清除条件
            </Button>
          </div>
        </div>
      ...
      {/* 货位详情弹窗 */}
      <Modal
        title={`库位详情: ${selectedLocation?.code || ''} ${selectedLocation?.name ? `(${selectedLocation.name})` : ''}`}
        open={detailVisible}
